...
export const SIDE_CONFIG = {
  ...
  dashboard: {
    ...
    sideMenus: [
      ...
      { id: "FO", name: "식품팀 대시보드", access:"회사 대시보드 열람" },
      { id: "BU", name: "뷰티·패션잡화팀 대시보드", access:"회사 대시보드 열람" },
      { id: "WF", name: "여성패션팀 대시보드", access:"회사 대시보드 열람" },
      { id: "MF", name: "남성패션팀 대시보드", access:"회사 대시보드 열람" },
      { id: "HR", name: "인사관리팀 대시보드", access:"회사 대시보드 열람" },
      { id: "FM", name: "시설자재팀 대시보드", access:"회사 대시보드 열람" },
      { id: "SO", name: "안전관리팀 대시보드", access:"회사 대시보드 열람" },
      { id: "AD", name: "권한 목록", access:"권한관리" },
      { id: "BO", name: "공지게시판", access:"회사 대시보드 열람" },
    ],
  },
  home: {
    title: "메인페이지",
